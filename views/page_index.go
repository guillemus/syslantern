...
func (r *Renderer) PatchIndexPage(sse *datastar.ServerSentEventGenerator, data AgentsIndexPageData) {
...
func (r *Renderer) PatchNewAgentDialog(w http.ResponseWriter, rr *http.Request, err string) {
